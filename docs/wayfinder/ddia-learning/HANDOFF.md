...
Built chapters: **3 (pilot), 1, 2, 4, 5, 6, 7, 8** all closed on the map. Nothing is claimed or
awaiting review. User's pattern so far: "close it, do the next chapter."

Remaining frontier: chapters 9–12 (tickets 12–15, in book order; user may name
